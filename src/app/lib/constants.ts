...
export const EXPERIENCE = [
    {
        ...
        description: 'Working as a Project Intern on Aconex',
        highlights: [
            'Developing New Features onto Aconex',
            'Bug Fixing and OCI Deployment onto Aconex',
            'Fair Bit of Exposure to RapidUI, Spring Boot, OJet and other frameworks'
        ]
    },
    {
...
export const PROJECTS = [
    {
        ...
        links: [
            { type: 'view', url: '#' },
            { type: 'source', url: 'https://github.com/keshav-019/sound-classification-using-esp32' }
        ]
    },
    {
        title: 'Rest Project',
        description: 'A Postman clone for testing REST APIs with additional features including Database Connections',
