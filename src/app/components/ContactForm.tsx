...
export default function ContactForm() {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            const res = await fetch('https://formspree.io/f/xkopoewz', {
                method: 'POST',
                headers: {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            >
                ...
                <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                />
